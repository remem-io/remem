...
//! Both are downloaded from Hugging Face and placed under `default_models_dir()`
...
pub const KNOWN_MODELS: &[ModelSpec] = &[ModelSpec {
    id: "nomic-embed",
...
/// already exist. Streams the response body so large ONNX files are never
