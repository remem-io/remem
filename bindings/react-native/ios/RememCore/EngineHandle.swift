...
/// the C ABI declared in `rememhq.h` (exposed to this file via
/// `RememCore-Bridging-Header.h`, configured in `Remem.podspec`'s
/// `SWIFT_OBJC_BRIDGING_HEADER`). Nothing outside this file should touch
/// these C functions directly — `Memory` (the public API) only sees safe
/// Swift types.
///
