...
// Operations
REMEM_API int remem_index_add(remem_index_t* index, const char* id, const float* data, size_t len);
REMEM_API int remem_index_remove(remem_index_t* index, const char* id);
...
REMEM_API int remem_index_save(remem_index_t* index, const char* path);
REMEM_API int remem_index_load(remem_index_t* index, const char* path);
